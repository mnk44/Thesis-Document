...
\subsection{Fases que Integran un Sistema de Capacitación}
Un proceso de evaluación de conocimiento (sistema de capacitación), debe estar integrado por cinco etapas (Figura \ref{fig:etapasEval}), asegura \cite{garcia1994}. Cada una de estas fases va a marcar un conjunto de acciones, que al final se interpretarán como un buen entrenamiento:
